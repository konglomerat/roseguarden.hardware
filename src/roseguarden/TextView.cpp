...
TextView::TextView() : header(Graphics::Coordinate_t{xCoordinate,yCoordinateHeader}),
					...
					bottomLine1(Graphics::Coordinate_t{xCoordinate,yCoordinateBottomLine1}),
					bottomLine2(Graphics::Coordinate_t{xCoordinate,yCoordinateBottomLine2}),
					bottomLine3(Graphics::Coordinate_t{xCoordinate,yCoordinateBottomLine3})
{
}
